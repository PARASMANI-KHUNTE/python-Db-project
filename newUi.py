...
def view():
    ...
    text.insert(tk.END, f"{'Good Habits': <20} {'Bad Habits': <20}\n{'='*45}\n")
    for element in elements:
        text.insert(tk.END, f"{element[0]: <20} {element[1]: <20}\n")
...
text = scrolledtext.ScrolledText(root, width=60, height=10, wrap=tk.WORD)
text.pack()
